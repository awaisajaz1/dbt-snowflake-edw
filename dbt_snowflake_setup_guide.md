...
GRANT ALL ON DATABASE DBT_DEMO TO ROLE ACCOUNTADMIN;
GRANT ALL ON ALL SCHEMAS IN DATABASE DBT_DEMO TO ROLE ACCOUNTADMIN;
GRANT ALL ON FUTURE SCHEMAS IN DATABASE DBT_DEMO TO ROLE ACCOUNTADMIN;
GRANT ALL ON ALL TABLES IN DATABASE DBT_DEMO TO ROLE ACCOUNTADMIN;
GRANT ALL ON FUTURE TABLES IN DATABASE DBT_DEMO TO ROLE ACCOUNTADMIN;
```
